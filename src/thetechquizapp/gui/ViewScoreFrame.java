...
public class ViewScoreFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jrbViewScoreSingleStudent.setBackground(new java.awt.Color(0, 0, 0));
        buttonGroup1.add(jrbViewScoreSingleStudent);
        jrbViewScoreSingleStudent.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jrbViewScoreSingleStudent.setForeground(new java.awt.Color(255, 102, 0));
        jrbViewScoreSingleStudent.setText("View Score Of A Single Student");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("F:\\Java program\\Java Project\\project-images\\stud1.jpg")); // NOI18N
    ...
    private void btnDoTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoTaskActionPerformed
        if(validateInput()==false)
                ...
                {
                    ViewAllScore viewAll=new ViewAllScore();
                    viewAll.setVisible(true);
                    this.dispose();
                }
                else
                {
                    SingleStudentFrame singleStudent=new SingleStudentFrame();
                    singleStudent.setVisible(true);
                    this.dispose();
                }
    ...
    private boolean validateInput() {
           if(jrbViewAllScores.isSelected()==false && jrbViewScoreSingleStudent.isSelected()==false)
        return false;
    else
        return true;
